...
def collect_daily(collectors: list, target_count: int = 10):
    seen_in_run = set()
    ...
    for collector in collectors:
        ...
        for job in collected:
            ...
            if not is_new:
                duplicates += 1
                continue
            save_match(row["id"], score_job(job))
            inserted += 1
    ...
    return {
        ...
        "note": "Only new jobs posted in the last 24 hours are returned. Old jobs are never used to fill the target.",
    }
